...
try {
    $secretdata = Get-SECSecretValue -SecretId $iasecretarn
    $secretdata = $secretdata.SecretString | ConvertFrom-Json
    #Set init variables
    ...
    Write-EventLog -LogName IrisAdmin -Source IrisAdmin -EntryType Information -EventId 1001 -Message "Iris Admin has started initializing"
}
catch {
